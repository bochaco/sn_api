...
impl Safe {
    ...
    // # Create or Update an NrsMapContainer.
    //
    // ## Example
    //
    // / ```rust
    ...
    pub fn nrs_map_update_or_create_data(
        ...
        // TODO: This should always add/overwrite exisitng entries at the moment
        ...
        if !the_rest_sub_names.is_empty() {
            ...
            for (i, the_sub_name) in the_rest_sub_names.iter().enumerate() {
                ...
                let mut default = NrsMap::default();
